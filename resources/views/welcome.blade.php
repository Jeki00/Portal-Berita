    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand" href="#page-top">UNS News</a>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-heading text-uppercase" style="color: #1565C0">UNS News</div>
                <div class="masthead-subheading">Tempat paling lengkap </div>
                <div class="masthead-subheading">Untuk melihat berita-berita terkini</div>
                <a class="nav-link" href="/register"><button type="button" class="btn btn-primary btn-lg">Daftar</button></a>
            </div>
        </header>
        <!-- Footer-->
