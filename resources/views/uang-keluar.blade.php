                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <div class="float-right d-none d-md-inline-block mr-4 dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-white" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="/pengeluaran/pdf"><i class="fas fa-file-pdf fa-fw mr-2 text-gray-400"></i>PDF</a>
                                    <a class="dropdown-item" href="/pengeluaran/excel"><i class="fas fa-file-excel fa-md fa-fw mr-2 text-gray-400"></i>Excel</a>
                                </div>
                            </div>
                        ...
                        <tbody class="text-center">
                            @foreach ($pengeluaran as $key => $keluar)
                                <tr>
                                    ...
                                    <td><a href="/edit-pengeluaran/{{$keluar['id']}}" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">
                                            <i class="fas fa-edit fa-sm text-white-50"></i> Edit</a></td>
                                    <td><button class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" data-toggle="modal" data-target="#deleteModal-{{$keluar['id']}}" >
...
@foreach ($pengeluaran as $keluar)
        <!-- Modal alert delete-->
<div class="modal fade" id="deleteModal-{{$keluar['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            Apakah anda yakin menghapus data <b> {{$keluar['keterangan']}} </b> dengan nominal <b> Rp.{{$keluar['nominal']}} </b> ?
            </div>
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <form action="hapus-pengeluaran/{{$keluar['id']}}" method="post">
                @csrf
                @method('DELETE')
