                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-left">
                                        <h1 class="h4 subhead text-blue-100 mb-3">Masuk ke akun</h1>
                                    </div>
                                    <div class="text-left">
                                        <h1 class="h6 text-gray-700 mb-4">Masuk dan jelajahi ragam berita di UNS News </h1>
                                    </div>
                                    <form class="user" action='/login' method='POST'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control form-control-user" id="password" name="password" placeholder="Masukkan kata sandi" required>
                                            @error('password')
                                            <div class="error">
                                                <p style="font-size: 13px;color: red;"> {{$message}} </p>
                                            </div>
                                    ...
                                    <div class="text-left">
                                        <a class="small text-blue-100" href="/register">Belum punya akun? Daftar</a>
                                    </div>
                                </div>
